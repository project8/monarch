/*
 * Monarch4MultithreadingTest.cc
 *
 *  Created on: Dec 22, 2016
 *      Author: N. Oblath
 *
 *  Use: Monarch4MultithreadingTest [options]
 *
 *  Options:
...
LOGGER( mlog, "M4MultithreadingTest" );
...
int main( int argc, char** argv )
{
    try
    {
        ...
        std::shared_ptr< Monarch4 > tWriteTest( Monarch4::OpenForWriting( tFilename ) );
        ...
        M4DataWriter< uint8_t > tDMWriter( tDataMaster.data(), tDataTypeSize, sDigitizedUS );
        ...
        std::vector< M4Stream* > tStreams( tNStreams );
