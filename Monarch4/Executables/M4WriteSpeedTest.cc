 ...
 *
 *  Use: Monarch4WriteSpeedTest [options]
 *
 *  Options:
...
int main( int argc, char** argv )
{
    ...
    try
    {
        ...
        std::shared_ptr< Monarch4 > tWriteTest( Monarch4::OpenForWriting( tFilePath.native() ) );
